...
export const CheckboxCompForm: Component = () => {
  ...
  return (
    <form autocomplete="off" onSubmit={submit}>
      <div class="mb-3">
        <Checkbox label="Accept policy" name="acceptPolicy" formHandler={formHandler} />
      </div>
      <div class="mb-3">
        <Checkbox label="Accept terms" name="acceptTerms" formHandler={formHandler} display="switch" />
      </div>
      <div class="mb-3">
        <Checkbox
          label={formData().accountStatus === 'active' ? 'Account active' : 'Account inactive'}
          value="active"
