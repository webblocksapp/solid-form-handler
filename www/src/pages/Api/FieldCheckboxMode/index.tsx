...
export const FieldCheckboxMode: Component = () => (
  <>
    <h2 class="mb-4 border-bottom">Field In Checkbox Mode</h2>
    <Code content={getRaw('CheckboxFieldApi')} />
    <p>
      <code>CheckboxFieldStore</code> is composed by:
    </p>
    <ul>
      <li>
      ...
      <li>
        <code>props.checked:</code> form handler computed checked flag to
    ...
    <ul>
      <li>
        <Link href="../../docs/validating-single-checkbox">
          Validating Checkbox
        </Link>
      </li>
    </ul>
