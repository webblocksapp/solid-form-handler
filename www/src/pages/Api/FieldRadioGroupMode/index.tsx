...
export const FieldRadioGroupMode: Component = () => (
  <>
    <h2 class="mb-4 border-bottom">Field In Radio Group Mode</h2>
    <Code content={getRaw('RadioGroupFieldApi')} />
    <p>
    ...
    <ul>
      <li>
        <Link href="../../docs/validating-radios">Validating Radios</Link>
      </li>
    </ul>
  </>
);
